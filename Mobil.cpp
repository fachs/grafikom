...
//	    glEnd();
		...
		glColor3f(0.329412, 0.329412, 0.329412); 
		glBegin(GL_POLYGON);
		glVertex2f(-500+i-xm,150);  //kanan bawah
		glVertex2f(-600+i-xm,300); //kiri atas
		glVertex2f(-800+i-xm,300); //kanan atas
		glVertex2f(-850+i-xm,150);//kiri bawah
		glEnd();
...
//		}
		...
		glColor3f(1.0,1.0,1.0);
		glBegin(GL_POLYGON);
		glVertex2f(-625+i-xm,220);//kiri bawah 
		glVertex2f(-625+i-xm,285); //kiri atas
		glVertex2f(-600+i-xm,285); //kanan atas
		glVertex2f(-560+i-xm,220); //kanan bawah
		glEnd();
		
		glColor3f(1.0,1.0,1.0);
		glBegin(GL_POLYGON);
		glVertex2f(-700+i-xm,220);//kiri bawah 
		glVertex2f(-700+i-xm,285); //kiri atas
		glVertex2f(-650+i-xm,285); //kanan atas
		glVertex2f(-650+i-xm,220); //kanan bawah
		glEnd();
		
		for(l=0;l<38;l++)
		   {
			glColor3f(0.35,0.16,0.14);
			draw_circle(-575+i-xm,150,l);
			draw_circle(-780+i-xm,150,l);
		   }
	}
	glFlush();
}
